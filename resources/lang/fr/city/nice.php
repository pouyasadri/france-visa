...
return [
    ...
    'consultation_request' => 'Demander une consultation pour l\'immigration à Nice',
    'email' => 'Email',
    ...
    'living_paragraph' => 'Nice figurait dans le top dix des villes les plus habitables de France en 2021. La capitale de la Côte d\'Azur, en obtenant la 7e place sur 500 au classement des villes françaises avec une bonne qualité de vie mené par l\'association Villes et Villes, a une fois de plus prouvé sa haute qualité de vie. En termes d\'identité, la ville de Nice a sa propre chanson spéciale. La diversité des perspectives et le style de vie unique définissent l\'essence de la vie et la beauté dans cette région étonnante et cela a fait de Nice enchanteur et encourage les gens à revenir. Vous ne trouverez même pas un moment pour vous ennuyer ici, tout est prêt pour la découverte et l\'intuition sans fin. Une autre caractéristique de Nice est que sa population est âgée. Si vous entrez dans l\'âge moyen, Nice est considérée comme une ville accueillante pour les personnes âgées et d\'âge moyen. La moitié des résidents ont plus de 43 ans et en comparaison, dans les autres villes du même rang, c\'est 36 ans. En 2010, 21,8 % de la population métropolitaine avait 65 ans ou plus (comparé à seulement 14,6 % ailleurs). À cet égard, Nice a la meilleure vie nocturne de la Côte d\'Azur. En fait, cette ville est une combinaison de styles culturels. Le Vieux Nice est composé de rues médiévales entrelacées, de marchés locaux et de boutiques traditionnelles. En revanche, le centre-ville est très moderne et bien équipé et rempli de centres commerciaux, de galeries avec des rangées de restaurants et de bars. En général, Nice est un bon endroit pour vivre. Vous vivrez complètement à la française ici, si vous voulez le style de vie français Nice est le bon choix. Il a tous les avantages des autres villes françaises (bonne nourriture et bon vin), plus le bonus d\'être sur la côte méditerranéenne. De plus, en général, Nice est une ville sûre et a généralement un taux relativement faible de crimes violents.',

    // Activities in Nice
    'living_activity_1' => 'Visitez la région des trésors',
    'living_activity_2' => 'Allez aux châteaux historiques',
    'living_activity_3' => 'Buvez des verres dans les hôtels',
    'living_activity_4' => 'Assistez à des fêtes de groupe',
    ...
    // Section: Language
    'language_heading' => 'La Langue des Gens de Nice',
    'language_paragraph' => 'Le français standard est la langue officielle des gens de Nice. Cependant, en tant que destination touristique internationale très populaire, vous remarquerez définitivement que l\'anglais est parlé dans de nombreux restaurants, bars et hôtels. Alors ne vous inquiétez pas du tout pour la langue. D\'autre part, le personnel des hôtels et des restaurants répond souvent en anglais au français qu\'ils utilisent, à moins que votre prononciation soit si professionnelle qu\'ils pensent que vous parlez un français correct. Alors s\'il vous plaît, ne vous sentez pas trop francophone à Nice, à moins que vous ayez appris un bon niveau de français.',
