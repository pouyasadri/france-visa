...
return [
    ...
    'consultation_request' => 'Request consultation for immigration to Nice',
    'email' => 'Email',
    ...
    'living_paragraph' => 'Nice was in the top ten most livable cities in France in 2021. The capital of the Azure Sea coast, by achieving 7th place out of 500 in the ranking of French cities with good living standards conducted by the Villes et Villes association, once again proved its high quality of life. In terms of identity, the city of Nice has its own special song. The diversity of perspectives and unique lifestyle define the essence of life and beauty in this amazing region and this has made Nice enchanting and encourages people to visit again. You won\'t even find a moment to get bored here, everything is ready for discovery and endless intuition. Another feature of Nice is that its population is elderly. If you are entering middle age, Nice is considered an age-friendly and middle-aged city. Half of the residents are over 43 years old and in comparison, in other cities of the same rank it is 36 years old. In 2010, 21.8% of the metropolitan population was 65 years or older (compared to only 14.6% elsewhere). In this respect, Nice has the best nightlife on the Azure coast. In fact, this city is a combination of cultural styles. Old Nice is made up of interwoven medieval streets, local markets and traditional shops. In contrast, the city center is very modern and well-equipped and full of shopping centers, galleries with rows of restaurants and bars. In general, Nice is a good place to live. You will live in complete French here, if you want French lifestyle Nice is the right choice. It has all the advantages of other French cities (good food and fine wine), plus the bonus of being on the Mediterranean coast. Also, generally Nice is a safe city, and generally has a relatively low rate of violent crime. The best things to do at night in Nice are visiting the treasure trove area, going to historic castles, having drinks in hotels, and attending group parties.',

    // Activities in Nice
    'living_activity_1' => 'Visit the treasure trove area',
    'living_activity_2' => 'Go to historic castles',
    'living_activity_3' => 'Have drinks in hotels',
    'living_activity_4' => 'Attend group parties',
    ...
    // Section: Language
    'language_heading' => 'The Language of Nice People',
    'language_paragraph' => 'Standard French is the official language of Nice people. However, as a very popular international tourist destination, you will definitely notice that English is spoken in many restaurants, bars and hotels. So don\'t worry about language at all. On the other hand, hotel and restaurant staff often respond in English to the French they use, unless your pronunciation is so professional that they think you speak decent French. So please don\'t feel too much like a Francophone in Nice, unless you have learned a good level of French.',
