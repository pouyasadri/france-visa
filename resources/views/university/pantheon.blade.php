                ...
                <div class="col-lg-8">
                    <div class="service-details-wrap" id="mydiv">
                        ...
                        <div class="single-services-imgs mb-30">
                            <img src="../assets/img/pantheon_university.jpg" alt="دانشگاه پانتئون سوربن پاریس">
                        </div>
                        <h3>تاسیس</h3>
                        ...
                        <div class="rooms-details mb-30">
                            <img src="../assets/img/pantheon_university_1.jpg" alt="دانشگاه پانتئون سوربن پاریس">
                        </div>
                        <h3>
                            جمعیت دانشجویان
                        </h3>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-md-6">
                                    <div class="service-list-img">
                                        <img src="../assets/img/pantheon.png" alt="دانشگاه پانتئون سوربن پاریس">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
