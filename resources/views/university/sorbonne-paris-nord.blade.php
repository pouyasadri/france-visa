...
@section("description","در این مقاله به معرفی دانشگاه پاریس شمال، یکی از بهترین دانشگاه های فرانسه می پردازیم. دانشگاه پاریس شمال در سال 1971 تاسیس شد و در حال حاضر بیش از 30000 دانشجو در آن تحصیل می کنند. این دانشگاه در زمینه های علوم، مهندسی، پزشکی، هنر و علوم انسانی دارای رتبه های برتری در جهان است.")
@section('content')
