...
@section('content')
    ...
    <div class="page-title-area">
        <div class="container">
            <div class="page-title-content">
                <h2>معرفی دانشگاه های فرانسه</h2>
                <ul>
                    <li>
                        <a href="index.html">
                            صفحه اصلی
                    ...
                    <li>معرفی دانشگاه های فرانسه</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="exclusive-area exclusive-area-two pt-100 pb-70">
        <div class="container">
            <div class="section-title">
                <span>دانشگاه های فرانسه</span>
                <h2>معرفی بهترین دانشگاه های فرانسه</h2>
            </div>
            <div>
                <p>
                    دانشگاه های فرانسه به عنوان یکی از مراکز آموزشی برتر در جهان شناخته می شوند. این دانشگاه ها، با بیش
                    از
                    ۸۰۰ دانشگاه و موسسه آموزشی، برای دانشجویان و پژوهشگران بین المللی، فرصت های آموزشی و تحقیقاتی عالی
                    ارائه
                    می دهند. دانشگاه های فرانسه معتبری مانند دانشگاه پاریس، دانشگاه سوربن، دانشگاه گرنوبل، دانشگاه لیون
                    و
                    دانشگاه اکس-آن-پرووانس، با برخورداری از کارنامه های عالی در زمینه های علوم پایه و کاربردی، علوم
                    انسانی و
                    هنر، مدیریت و اقتصاد، رشته های فنی و مهندسی و سایر رشته های تحصیلی، دانشجویان بین المللی را به خود
                    جذب
                    کرده اند. بعلاوه، دانشگاه های فرانسه با ارائه بورس های تحصیلی و دسترسی به امکانات مدرن آموزشی و
                    تحقیقاتی، به دانشجویان خارجی کمک می کنند تا بهترین تجربه آموزشی و تحقیقاتی را در فرانسه کسب کنند.
                </p>
            </div>
            <div class="row">
    ...
    <section class="our-rooms-area-two pb-100">
        <div class="container">
            <div class="section-title">
                <span>تحصیل در فرانسه</span>
                <h2>فرصت های تحصیل در فرانسه</h2>
            </div>
            <div>
                <p>تحصیل در فرانسه به عنوان یکی از کشورهای برجسته در زمینه آموزش عالی، بسیاری از مزایا و فرصت‌های
                    منحصربه‌فرد را برای دانشجویان به ارمغان می‌آورد. در زیر شش تا از بهترین مزایای تحصیل در فرانسه آورده
                    شده
                    است:</p>
            </div>
