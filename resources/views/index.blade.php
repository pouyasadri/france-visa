...
@section('content')
    ...
    <section class="facilities-area pb-60">
        <div class="container">
            <div class="section-title">
                <span>{{ __('index.facilities.subtitle') }}</span>
                <h2>{{ __('index.facilities.title') }}</h2>
            </div>
            <div class="row">
                @foreach(__('index.facilities.items') as $facility)
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-facilities-wrap">
                            <div class="single-facilities">
                                ...
                                <p style="padding:0;margin: 0">{{ $facility['label'] }}</p>
    ...
    <section id="services" class="bokking-area pt-70 pb-70">
        <div class="container">
            <div class="section-title">
                <span>{{ __('index.services.subtitle') }}</span>
    ...
    <section class="restaurants-area ptb-100 ">
        <div class="container-fluid p-0">
            <div class="section-title">
                <span>{{ __('index.houses.subtitle') }}</span>
                <h2>{{ __('index.houses.title') }}</h2>
            </div>
            ...
            <div class="restaurants-wrap owl-carousel owl-theme">
                @forelse($houses as $house)
                    <div class="single-restaurants"
                        ...
                        <p>{{$house->house_region}}
                            | {{$house->house_price == 0 ? __('index.houses.price_contact') : $house->house_price}}</p>
                        <a href="{{url(app()->getLocale()."/house/$house")}}" class="default-btn">
                            {{ __('index.houses.button') }}
                            <i class="{{ $arrowIcon }}"></i>
                        </a>
                    </div>
        ...
        @verbatim
            {
              ...
              "@type": "WebSite",
              "name": "{{ __('index.schema.name') }}",
          "url": "{{ __('index.schema.url') }}",
          "potentialAction": {
            "@type": "SearchAction",
